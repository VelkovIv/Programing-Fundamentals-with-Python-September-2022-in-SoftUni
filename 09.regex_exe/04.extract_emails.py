...
---------------------------------------------------
--->Input
Many users @ SoftUni confuse email addresses. We @ Softuni.BG provide high-quality training @ home or @
 class. –- steve.parker@softuni.de.
Output--->
...
emails = re.findall(pattern, current_input)
